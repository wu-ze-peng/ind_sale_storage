...
import com.jmm.ind_sale_storage.core.annotation.Module;
...
public class ModuleLogger {
    ...
    @AfterThrowing(value = "execution(* com.jmm.ind_sale_storage.service.impl.*.*(..)) && @annotation(mod))",throwing = "ex")
    ...
    @Before(value = "execution(* com.jmm.ind_sale_storage.service.impl.*.*(..)) && @annotation(mod))")
